...
// ==========================================
const opcodes = {
    'NOP': 0,      // 0000 0000 | ไม่ทำงานอะไร
    'HLT': 16,     // 0001 0000 | หยุดการทำงานของ CPU
    'ADD': 32,     // 0010 0000 | บวกค่าจากรีจิสเตอร์/แรม
    'SUB': 48,     // 0011 0000 | ลบค่า
    'NOR': 64,     // 0100 0000 | ตรรกะ NOR
    'AND': 80,     // 0101 0000 | ตรรกะ AND
    'XOR': 96,     // 0110 0000 | ตรรกะ XOR
    'RSH': 112,    // 0111 0000 | เลื่อนบิตไปทางขวา (Right Shift)
    'LDI': 128,    // 1000 0000 | โหลดค่าคงที่โดยตรง (Load Immediate)
    'ADI': 144,    // 1001 0000 | บวกค่าคงที่โดยตรง (Add Immediate)
    'JMP': 160,    // 1010 0000 | กระโดดไปยังตำแหน่งที่กำหนด (Jump)
    'BRH': 176,    // 1011 0000 | กระโดดแบบมีเงื่อนไข (Branch)
    'CAL': 192,    // 1100 0000 | เรียกฟังก์ชันย่อย (Call Subroutine)
    'RET': 208,    // 1101 0000 | ย้อนกลับจากฟังก์ชันย่อย (Return)
    'LOD': 224,    // 1110 0000 | โหลดข้อมูลจากแรม (Load จาก Address)
    'STR': 240     // 1111 0000 | บันทึกข้อมูลลงแรม (Store ไปยัง Address)
};
